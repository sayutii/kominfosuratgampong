...
<tr>
    <td><center>
        <font size="4">SURAT KETERANGAN DOMISILI</font></center><BR>
    </td>
    </tr>
    <tr>
...
@foreach ($sdomisili as $data)
    ...
    <tr>
        <td>Status</td>
        <td width="500"> : {{ $data->status }}</td>
    </tr>
    <tr>
        <td>Pekerjaan</td>
        <td width="500"> : {{ $data->pekerjaan }}</td>
    </tr>
    <tr>
        <td>Alamat</td>
    ...
    <tr>
        <td colspan="2" align="justify">Adalah benar-benar warga masyarakat Kampung Punge Jurong, dengan
         ini kami memberikan<br> Surat Keterangan Domisili kepeda yang bersangkutan untuk dapat dipergunakan sebagaimana<br>
         mestinya. 
         </td>
    </tr>  
    @endforeach
